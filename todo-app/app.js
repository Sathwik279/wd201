...
//Hash the password using bcrypt
  ...
  try{
    ...
    request.login(user,(err)=>{//once the user is created we are passing the user object through the request.login functin and this allow the user object through the todos endpoint
      if(err){
        console.log(err)
      }
